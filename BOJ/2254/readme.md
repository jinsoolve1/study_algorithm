## [백준 2254 - 감옥 건설](https://www.acmicpc.net/problem/2254)

### 알고리즘
- convex hull

### 풀이
담 = 다각형, 담벼락 = 다각형의 모서리, 담 기둥 = 다각형의 꼭짓점을 의미힌다.  
감옥을 최대한 많은 담으로 감싸는 문제다.
1. 현재 점들 중에서 convex hull 을 이루는 점들을 찾는다.
2. 찾은 convex hull이 감옥을 포함하고 있는 지를 확인한다.
3. 점들에서 convex hull로 채택한 점들을 제거한다.
