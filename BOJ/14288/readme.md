## [백준 14288 - 회사 문화 4](https://www.acmicpc.net/problem/14288)
...
### 풀이
1. 오일러 경로 테크닉을 이용해 각 노드별 in과 out index를 저장한다.
2. 상사 -> 부하 로의 칭찬은 lazy segment로 체크한다.
3. 부하 -> 상사 로의 칭찬은 segment로 체크한다.
4. i번째 직원이 받은 칭찬은 lazy segment(i) + segment(i)가 된다.
