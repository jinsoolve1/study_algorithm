## [백준 14287 - 회사 문화 3](https://www.acmicpc.net/problem/14287)
...
### 풀이 
자신의 부하들 중 한명이 칭찬을 받았으면 자신도 칭찬을 받는다.    
따라서, 직원 a의 칭찬을 받은 정도는 a의 부하직원들이 자신의 직속부하로부터 얼마만큼의 칭찬을 받았는지를 전부 더하면 된다.  

구간변경이 요구되지 않고 구간합만 요구된다. 세그먼트 트리로 해결이 가능하다.  
구간합을 구할 떄 오일러 경로 테크닉을 이용해서 연속적인 구간으로 만들면 해결 가능하다.
