## [백준 10255 - 교차점](https://www.acmicpc.net/problem/10255)
...
### 풀이
1. 직사각형의 한 변씩 체크하면서 총 몇 개의 점에서 만나는 지 체크한다.
2. 직사각형의 꼭짓점에서 만나면 개수를 중복해서 세므로 하나를 제거해준다.
3. ccw를 이용하여 선분 교차 판정을 해준다.
