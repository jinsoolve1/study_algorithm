## [백준 18437 - 회사 문화 5](https://www.acmicpc.net/problem/18437)
...
### 풀이
1. 오일러 경로 테크닉으로 노드들의 in, out 인덱스를 구한다.
2. lazy segment tree를 이용해 구간 변경을 구현한다.
3. 주의할 점은 리프 노드의 값이 0 혹은 1이므로 그에 알맞게 구현해야 한다.
